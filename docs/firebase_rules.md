  ...
  "rules": {
      ...
      "$uid": {
        ...
        "folders": {
          "$folderId": {
            ...
            "color": {
              ".validate": "newData.isString() && newData.val().matches(/^#[0-9a-f]{6}$/i)"
            },
        ...
        "devices": {
          "$deviceId": {
            ...
            "type": {
              ".validate": "newData.val() === 'desktop' || newData.val() === 'mobile' || newData.val() === 'tablet' || newData.val() === 'laptop'"
            },
        ...
        "globalLinks": {
          "$linkId": {
            ".validate": "newData.hasChildren(['url', 'createdAt'])",
    ...
    "qr-sessions": {
      "$sessionId": {
        ...
        "userId": {
          ".validate": "newData.isString() || !newData.exists() || newData.val() === null"
        },
